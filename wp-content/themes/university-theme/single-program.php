...
// you used when registering the new post type
  get_header();
      ...
      <?php
          ...
          $relatedProfessors = new WP_Query(array(
            ...
            'meta_query' => array(
              array(
                'key' => 'related_program',
                'compare' => 'LIKE', // LIKE here means contains
                'value' => '"' . get_the_ID(). '"'
              )
            )
          ));
          ...
          // when you have multiple custom queries on a single page it is advisable to do this function between them. 
          // It resets the global post object to the base default url query
          wp_reset_postdata(); 
          ...
          if ($homepageEvents->have_posts()) {            
            ...
            while ($homepageEvents->have_posts()) {
              ...
              get_template_part('template-parts/content-event', 'event'); // to efficiently reuse code
           }
          }
