...
<html <?php language_attributes(); ?>>
  <head>
    ...
    <!-- wp_head() - give WordPress the final say in what to load in the head -->
    <?php wp_head(); ?>
  </head>
  <body <?php body_class(); ?>>
      ...
      <div class="container">
        ...
        <div class="site-header__menu group">
          <nav class="main-navigation">
            <ul>
              <!-- is_page checks to see if current page is the page based on the slug we use as parameter, if true add a class -->
              <li <?php if (is_page('about-us') or wp_get_post_parent_id(get_the_ID()) == 11) echo 'class="current-menu-item"' ?>><a href="<?php echo esc_url(site_url('/about-us')); ?>">About Us</a></li>
          ...
          <div class="site-header__util">
            <?php if (is_user_logged_in()) { ?>
               <a href="<?php echo wp_logout(); ?>" class="btn btn--small  btn--dark-orange float-left btn--with-photo">
